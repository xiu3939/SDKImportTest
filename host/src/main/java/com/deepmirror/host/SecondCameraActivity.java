...
import com.deepmirror.host.databinding.ActivitySecondCameraBinding;
...
public class SecondCameraActivity extends AppCompatActivity {
    ...
    private ActivitySecondCameraBinding binding;
    ...
    private void initView() {
        binding = ActivitySecondCameraBinding.inflate(getLayoutInflater());
    ...
    private void calibrate() {
        camView.startCalibration((dx, dy) -> {
            Toast.makeText(SecondCameraActivity.this, String.format(Locale.getDefault(), "Calibrate success,dx=%d,dy=%d", dx, dy), Toast.LENGTH_SHORT).show();
            startScanBarcode();
        });
    }
